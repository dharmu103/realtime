  ...
  if (
    ...
    var clock_end_time =
      end_time.getMinutes() === 0
        ...
        ? end_time.getHours() + ":0" + end_time.getMinutes() + ampm
...
function update_event(message, events) {
  ...
  for (let element of events) {
    ...
    if (element.is_event_active) {
      ...
      //   var updated_diff_price =
      //     element.diff_price /100 *
      //       (element.end_time_miliseconds -dateTime ) /
      //     (element.end_time_miliseconds - element.start_time_miliseconds) *100;
      //   var rate_change =
      //     (element.current_diff_price - updated_diff_price) /
      ...
      var probability_of_total_change = (rate_change * time_change) / 100;
      var probability_of_created_price =
        element.current_diff_price / probability_of_total_change;
      //           console.log(probability_of_total_change)
      // console.log(time_change)
      // console.log(element.current_diff_price)
      console.log(
        `probability_of_created_price = ${probability_of_created_price}`
      );
      element.yes_price = parseFloat(
        5 + probability_of_created_price * 10
      ).toFixed(1);
      element.no_price = parseFloat(
        5 - probability_of_created_price * 10
      ).toFixed(1);
    }
